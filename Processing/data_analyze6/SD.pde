class SD {
  ...
  void display() { //makes a square of different color for each variable with height according to how many standard deviations it is away from mean
    ...
    beginShape();
    vertex(   0, 0, 100);
    bezierVertex(-90, -77, -55, -40, -33, -17, -100*sd_off_press, -100, -100);
    bezierVertex( 80, -50, -35, 50, -20, -5, 100*sd_off_hum, -100, -100);

    vertex(   0, 0, 100);
    bezierVertex( 80, -50, -35, 50, -20, -5, 100*sd_off_hum, -100, -100);
    bezierVertex( 80, 65, -90, 20, 35, -50, 100*sd_off_mess, 100, -100);
