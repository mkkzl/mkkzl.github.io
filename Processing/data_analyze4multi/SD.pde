class SD {
  ...
  void makeshape() {
    ...
    endShape(CLOSE);
    println(sd_off_press);
  }
  void display(int i) { //makes a square of different color for each variable with height according to how many standard deviations it is away from mean
    ...
    case 1:
      pushMatrix();  
      translate(width/8*3, height/8);
      scale(.25);
      makeshape();
      popMatrix();
    case 2:
      pushMatrix();  
      translate(width/8*5, height/8);
      scale(.25);
      makeshape();
      popMatrix();
    case 3:
      pushMatrix();    
      translate(width/8, height/8*4);
      scale(.25);
      makeshape();
      popMatrix();
    case 4:
      pushMatrix();  
      translate(width/8*3, height/8*4);
      scale(.25);
      makeshape();
      popMatrix();
    case 5:
      pushMatrix();  
      translate(width/8*5, height/8*4);
      scale(.25);
      makeshape();
      popMatrix();
    case 6:
