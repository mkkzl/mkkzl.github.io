...
var quizJSON = {
    "info": {
        "name":    "Your experience will begin shortly",
        "main":    "<p>Think of an elderly individual in your life.</p><p>Keep them in mind when filling in the following statements.</p>",
        "results": "",
    ...
    "questions": [
        { // Question 1 - Multiple Choice, Single True Answer
            "q": "Fill in the blank: <br> They ______ a great conversationalist",
            "a": [
                {"option": "are",  "present": true},
                {"option": "were", "present": false},
                {"option": "are not",  "present": true},
                {"option": "were not", "present": false} // no comma here
            ],
            "present": "<h4><span>You picked present tense</span> </h4>",
            "incorrect": "<h4><span>You picked past tense</span> </h4>" // no comma here
        },
